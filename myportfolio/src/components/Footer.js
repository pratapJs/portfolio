...
export default function Footer(props){
    ...
    <Grid container justify="center" className={classes.mainContainer}>
        ...
        <Grid item className={classes.gridItem}>
            <Grid container direction="column" spacing={2}>
                <Grid item component={Link} onClick={()=>props.setValue(2) } to="/projects" className={classes.link}>
                   Projects
                </Grid>
            </Grid>
        </Grid>
        <Grid item className={classes.gridItem}>
            <Grid container direction="column" spacing={2}>
                <Grid item component={Link} onClick={()=>props.setValue(3) } to="/contact" className={classes.link}>
                  Contact
                </Grid>
            </Grid>
        </Grid>
        <Grid item className={classes.gridItem}>
            <Grid container direction="column" spacing={2}>
                <Grid item component={Link} onClick={()=>{props.setValue(4); props.setSelectedIndex(0) }} to="/services" className={classes.link}>
                    Services
                </Grid>
                
       
                            <Grid item component={Link} onClick={()=>{props.setValue(4); props.setSelectedIndex(1)}}to="/appsdevelopment" className={classes.link}>
                  IOS/Android App Development
               
            </Grid>
             
                
                <Grid item component={Link} onClick={()=> {props.setValue(4); props.setSelectedIndex(2) } }to="/websitedevelopment" className={classes.link}>
                   Website Development
